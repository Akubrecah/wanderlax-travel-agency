...
export default function AmalfiCoastItinerary() {
  return (
    <div className="bg-neutral-100 text-slate-900 font-display p-4 md:p-8 min-h-screen">
      ...
      `}} />
      <div className="max-w-[1000px] mx-auto bg-white min-h-screen shadow-2xl my-0 md:my-10 overflow-hidden relative border-t-8 border-primary print:shadow-none print:my-0 print:border-none">
        ...
        <header className="pt-12 px-8 md:px-16 flex flex-col md:flex-row justify-between items-end gap-6">
          ...
          <div className="text-right">
            <h1 className="text-4xl md:text-5xl font-black text-slate-900 leading-none">The Eternal <br/><span className="text-primary">Amalfi Coast</span></h1>
          </div>
        </header>

        {/* Hero Image */}
        <div className="px-8 md:px-16 mt-10">
          <div className="relative w-full h-[450px] rounded-xl overflow-hidden bg-slate-200 shadow-lg print:shadow-none">
        ...
        <div className="px-8 md:px-16 mt-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border border-slate-200 rounded-xl divide-y md:divide-y-0 md:divide-x divide-slate-200">
            <div className="p-8 flex flex-col gap-1 items-center md:items-start">
              <span className="text-primary text-xs font-bold uppercase tracking-widest">Duration</span>
              <span className="text-2xl font-black text-slate-900">8 Days / 7 Nights</span>
            </div>
            <div className="p-8 flex flex-col gap-1 items-center md:items-start">
              <span className="text-primary text-xs font-bold uppercase tracking-widest">Group Size</span>
              <span className="text-2xl font-black text-slate-900">Max 12 Guests</span>
            </div>
            <div className="p-8 flex flex-col gap-1 items-center md:items-start">
              <span className="text-primary text-xs font-bold uppercase tracking-widest">Available Dates</span>
        ...
        {/* Itinerary Content */}
        <div className="px-8 md:px-16 mt-16 print-break">
          ...
          <div className="space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-[140px_1fr] gap-6">
              <div className="flex flex-col">
                <span className="text-primary font-black text-2xl leading-none">DAY 01</span>
              ...
              <div className="border-l-2 border-slate-100 pl-8 pb-4">
                ...
                <div className="mt-4 flex items-center gap-4">
                  <span className="flex items-center gap-1 text-[11px] font-bold text-slate-400 uppercase tracking-tighter"><span className="material-symbols-outlined text-sm text-primary">restaurant</span> Dinner Included</span>
                  <span className="flex items-center gap-1 text-[11px] font-bold text-slate-400 uppercase tracking-tighter"><span className="material-symbols-outlined text-sm text-primary">bed</span> Hotel Excelsior</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-[140px_1fr] gap-6">
              <div className="flex flex-col">
                <span className="text-primary font-black text-2xl leading-none">DAY 02</span>
              ...
              <div className="border-l-2 border-slate-100 pl-8 pb-4">
                ...
                <div className="mt-4 flex items-center gap-4">
                  <span className="flex items-center gap-1 text-[11px] font-bold text-slate-400 uppercase tracking-tighter"><span className="material-symbols-outlined text-sm text-primary">restaurant</span> Breakfast &amp; Lunch</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-[140px_1fr] gap-6">
              <div className="flex flex-col">
                <span className="text-primary font-black text-2xl leading-none">DAY 03</span>
        ...
        <div className="px-8 md:px-16 mt-16 pt-16 border-t border-slate-100 pb-20 print-break">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div>
              <h4 className="text-sm font-black uppercase tracking-widest text-primary mb-6">What&apos;s Included</h4>
            ...
            <div className="bg-slate-50 p-8 rounded-xl border border-slate-200">
              ...
              <div className="space-y-6">
                <div>
                  <span className="block text-xs font-bold text-primary uppercase mb-1">Visas &amp; Documents</span>
                ...
                <div>
                  <span className="block text-xs font-bold text-primary uppercase mb-1">Packing Essentials</span>
                ...
                <div>
                  <span className="block text-xs font-bold text-primary uppercase mb-1">Activity Level</span>
        ...
        <footer className="bg-slate-900 text-white p-12 mt-12 print-break">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <div className="flex flex-col md:flex-row gap-8 text-center md:text-left">
              ...
              <div className="flex flex-col">
                <span className="text-[10px] font-bold text-primary uppercase tracking-widest mb-2">Visit</span>
            ...
            <div className="flex flex-col items-center md:items-end">
              ...
              <div className="bg-white p-2 rounded-lg">
                <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuDgUT1ZXQ1WPSGzTbSoXKRaePxboXYzi05Q1T1zTO164yDrCKttba3VnvWYtHtvORq4q_YETTnIfJgk5GzsgLPh3UTapXn2goVTFNujWm1UKi5vVfHe_EHVDdy7nu4-6gAHlogkdv_R37jVroQP9kCphA6KRPGQ_XEctCtOlW6dkhUm7ConGYVZcQFRcE9mG9GSGjEgdqzIGZBg40OtGA-TOOLge7fR_OqFti6QDJPSb1h7NApWYHzsO6KBbw-kkMY8oma4P1k96w" alt="QR Code" className="w-12 h-12" />
              </div>
            </div>
          </div>
        ...
        <button 
          className="no-print fixed bottom-8 right-8 bg-primary text-white p-4 rounded-full shadow-2xl hover:scale-105 transition-transform flex items-center justify-center cursor-pointer min-w-16 min-h-16"
